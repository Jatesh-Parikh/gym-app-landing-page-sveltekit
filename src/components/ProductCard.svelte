...
<div class="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-14 lg:gap-20 relative text-base max-w-[1200px] mx-auto">
    <div class={"flex flex-col gap-8 md:gap-10 pt-8 md:pt-10" + (index % 2 === 1 ? " md:order-2" : "")}>
        ...
        <p class="mt-4 md:mt-8">{productFeature.description}</p>
    ...
    <div class="flex flex-col dropShadow overflow-hidden rounded-b-lg">
        ...
        <div class="flex flex-col bg-white gap-4 flex-1">
            <img src={productFeature.imgUrl} alt="product">
        </div>
    </div>
</div>